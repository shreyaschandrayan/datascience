...
sales_train = pd.read_csv(r'C:/DSPR_Data_Sets/Website Data Sets/clothing_sales_training.csv')
sales_test = pd.read_csv(r'C:/DSPR_Data_Sets/Website Data Sets/clothing_sales_test.csv')
